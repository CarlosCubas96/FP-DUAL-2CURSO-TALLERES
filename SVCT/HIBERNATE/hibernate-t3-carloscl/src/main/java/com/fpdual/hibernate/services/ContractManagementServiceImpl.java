...
public class ContractManagementServiceImpl implements ContractManagementServiceI {
	...
	public List<Contract> searchContractByClientIdentityDocument(String identityDocument) {
		...
		if (identityDocument != null) {
			// Obtención de contratos por DNI del cliente.
			contractsList = contractDao.searchContractByClientIdentityDocument(identityDocument);

			// Log de la operación.
			Utils.log(Utils.INFO, "Contratos encontrados por identityDocument de cliente: " + identityDocument);
		} else {
			// Log de error si el DNI del cliente es nulo.
			Utils.log(Utils.ERROR, "DNI de cliente nulo.");
		}
