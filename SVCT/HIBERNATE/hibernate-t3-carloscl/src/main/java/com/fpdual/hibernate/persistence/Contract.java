 ...
 * 
 * La relación con Cliente es de 1:1, un contrato solo puede estar asociado a un
 * cliente.
 * 
 * @author Carlos
 *
...
public class Contract extends AbstractEntity implements Serializable {
	...
	public String toString() {
		return "Contract{" + "contractId=" + contractId + ", client=" + client + ", startDate=" + startDate
				+ ", endDate=" + endDate + ", monthlyPrice=" + monthlyPrice + '}';
	}
}
