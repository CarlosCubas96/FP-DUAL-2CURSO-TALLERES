 ...
 * 
 * Clase que representa un Cliente. Extiende la clase AbstractEntity para
 * heredar propiedades de auditoría.
 * 
 * La relación con Contrato es de 1:N, un cliente puede tener varios contratos.
 * 
 * @author Carlos
 *
 */
...
public class Client extends AbstractEntity implements Serializable {
	...
	/**
	 * Obtiene contratos asociados al cliente.
	 * 
	 * @return Contratos asociados al cliente.
	 */
	...
	/**
	 * Establece los contratos asociados al cliente.
	 * 
	 * @param contracts Contratos asociados al cliente.
	 */
