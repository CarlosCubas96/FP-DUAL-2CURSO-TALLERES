    ...
    <div class="container mt-5">
        ...
        <form action="CreateContractServlet" method="post">
            ...
            <div class="form-group">
                ...
                <input type="hidden" class="form-control" id="clientId" name="clientId" value="${client.clientId}" readonly>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="monthlyPrice" name="monthlyPrice" required>
            </div>
